            ...
            <div className='flex items-center justify-center text-main flex-col lg:flex-row gap-y-5 mt-10' id="about">
                ...
                <div className='w-full flex items-center justify-center flex-col gap-y-10'>
                    ...
                    <a href="https://t.me/attackonshiba" target="_blank" rel="noreferrer noopener">
                        <button className='w-fit overflow-hidden group h-auto px-10 py-4 mt-4 bg-button rounded-lg cursor-pointer hover:bg-buttonHover transition-all ease-in-out duration-300 flex items-center gap-x-4 font-aot md:text-3xl text-2xl'>
                            <p className=''>Interact with Jimmy</p>
